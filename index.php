 ...
 */
require_once(WP_PLUGIN_DIR . '/toaster-contact-form-by-duo-leaf/duo-leaf/duoleaf.php');
...
require_once(WP_PLUGIN_DIR . '/toaster-contact-form-by-duo-leaf/core/plugin-info.php');
